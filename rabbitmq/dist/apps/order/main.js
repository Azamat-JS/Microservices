...
exports.NOTIFICATION_CLIENT = exports.PAYMENT_CLIENT = void 0;
exports.PAYMENT_CLIENT = "payment";
exports.NOTIFICATION_CLIENT = "notification";
...
let OrderController = class OrderController {
    ...
    constructor(orderService, paymentMQClient, notificationMQClient) {
        this.orderService = orderService;
        this.paymentMQClient = paymentMQClient;
        this.notificationMQClient = notificationMQClient;
    }
    getHello() {
...
exports.OrderController = OrderController = __decorate([
    ...
    __param(1, (0, common_1.Inject)(constant_1.PAYMENT_CLIENT)),
    __param(2, (0, common_1.Inject)(constant_1.NOTIFICATION_CLIENT)),
    __metadata("design:paramtypes", [typeof (_a = typeof order_service_1.OrderService !== "undefined" && order_service_1.OrderService) === "function" ? _a : Object, typeof (_b = typeof microservices_1.ClientProxy !== "undefined" && microservices_1.ClientProxy) === "function" ? _b : Object, typeof (_c = typeof microservices_1.ClientProxy !== "undefined" && microservices_1.ClientProxy) === "function" ? _c : Object])
], OrderController);
    ...
    (0, common_1.Module)({
        imports: [
            microservices_1.ClientsModule.register([
                {
                    name: constant_1.PAYMENT_CLIENT,
            ...
            microservices_1.ClientsModule.register([
                {
                    name: constant_1.NOTIFICATION_CLIENT,
                    transport: microservices_1.Transport.RMQ,
                    options: {
                        urls: ["amqp://guest:guest@localhost:5672"],
...
async function bootstrap() {
    ...
    await app.listen();
    common_1.Logger.log('Order service is listening to RMQ');
}
bootstrap();
