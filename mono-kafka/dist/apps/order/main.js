...
let OrderController = class OrderController {
    orderService;
    kafkaClient;
    constructor(orderService, kafkaClient) {
...
], OrderController.prototype, "newOrder", null);
exports.OrderController = OrderController = __decorate([
    (0, common_1.Controller)(),
    __param(1, (0, common_1.Inject)('KAFKA_SERVICE')),
    __metadata("design:paramtypes", [typeof (_a = typeof order_service_1.OrderService !== "undefined" && order_service_1.OrderService) === "function" ? _a : Object, typeof (_b = typeof microservices_1.ClientKafka !== "undefined" && microservices_1.ClientKafka) === "function" ? _b : Object])
], OrderController);
...
async function bootstrap() {
    ...
    await app.listen();
    common_1.Logger.log('Order service is listening to Kafka...');
}
bootstrap();
